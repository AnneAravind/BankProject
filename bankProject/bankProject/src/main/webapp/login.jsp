...
<div id=one
		...
		<h1 id="ha" style="color: red;">LOGIN PAGE</h1>
		<form action="enter" method="post">
			...
			<br> 
			<span class="forgot-password"><a href="forgotPassword.jsp">Forgot Password ?</a></span><br><br>
			<input class="one" type="Submit" value="Login" name="value1" href="https://www.tesla.com">
			 <span class="two">Don't have an account? <a href="register.jsp">Sign up</a></span>
		</form>
</div>
</body>
</html>